#############################################################################
# Makefile for building: processImage.app/Contents/MacOS/processImage
# Generated by qmake (3.1) (Qt 6.7.0)
# Project:  processImage.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile processImage.pro
#############################################################################
...
CFLAGS        = -pipe -g $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk -mmacosx-version-min=14.0 -Wall -Wextra $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -g -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk -mmacosx-version-min=14.0 -Wall -Wextra $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = processImage1.0.0
DISTDIR = /Users/nicholascaruso/sscan/.tmp/processImage1.0.0
...
SOURCES       = displayImages.cpp 
OBJECTS       = displayImages.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		processImage.pro  displayImages.cpp
QMAKE_TARGET  = processImage
DESTDIR       = 
TARGET        = processImage.app/Contents/MacOS/processImage

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.5
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/nicholascaruso/sscan/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/nicholascaruso/sscan/processImage.pro
...
processImage.app/Contents/MacOS/processImage:  $(OBJECTS)  
	@test -d processImage.app/Contents/MacOS/ || mkdir -p processImage.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: processImage.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile processImage.pro
...
processImage.app/Contents/PkgInfo: 
	@test -d processImage.app/Contents || mkdir -p processImage.app/Contents
	@$(DEL_FILE) processImage.app/Contents/PkgInfo
	@echo "APPL????" > processImage.app/Contents/PkgInfo
processImage.app/Contents/Info.plist: 
	@test -d processImage.app/Contents || mkdir -p processImage.app/Contents
	@$(DEL_FILE) processImage.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,ggg.processImage,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},ggg.processImage,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,processImage,g" -e "s,@LIBRARY@,processImage,g" -e "s,\$${EXECUTABLE_NAME},processImage,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >processImage.app/Contents/Info.plist

all: Makefile \
		processImage.app/Contents/PkgInfo \
		processImage.app/Contents/Info.plist processImage.app/Contents/MacOS/processImage
...
distdir: FORCE
	...
	$(COPY_FILE) --parents displayImages.cpp $(DISTDIR)/
...
displayImages.o: displayImages.cpp /opt/homebrew/lib/QtWidgets.framework/Headers/QApplication \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o displayImages.o displayImages.cpp
